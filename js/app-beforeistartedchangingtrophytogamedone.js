...
function listSelected(clickedList){
    ...
    for(var i = 0; i < selectedList.trophies.length; i++){
        ...
        if(localStorage.getItem("g-" + thisTrophy.name) == "true"){
            trophyEarned = "earned_trophy";
            trophyChecked = "checked=\"true\"";
            trophyCount++;
        }

        if(localStorage.getItem("o-" + thisTrophy.game) == "true"){
            gameCount++;
        ...
        /* $("#trophy-list").append("" +
            ...
            "<div class=\"row\">" +
            "<div class=\"col-sm-1\">" +
            "<img src=\""+ thisTrophy.imag +"\" alt=\""+ thisTrophy.game +"\" class=\"img-responsive\">" +
            "</div>" +
            "<div class=\"col-sm-9\">" +
            "<h3 class=\"game\" data-game-name=\""+ thisTrophy.game +"\">"+ thisTrophy.game +"</h3>" +
            "</div>" +
...
function saveTrophy(e) {
    ...
    if(checked){
        localStorage.setItem("g-" + thisTrophy, true);
    } else {
        localStorage.removeItem("g-" + thisTrophy);
    }
...
function saveGame(e) {
    ...
    if(checked){
        localStorage.setItem("o-" + thisGame, true);
    } else {
        localStorage.removeItem("o-" + thisGame);
    }
}
